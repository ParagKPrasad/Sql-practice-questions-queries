...
-- Q2. Retrieve the complete details of the transaction with the highest sale amount.
SELECT *
FROM sales
WHERE sale_amount =
(
...
-- Q4. Find all sales of products sold by more than 2 different salespersons.
...
-- Q5. Find all sales from regions whose average sale amount is above the overall average sale amount.
...
-- Q6. Find all sales where the sale amount is higher than every sale amount in the Furniture category.
...
-- Q7. Find all sales where the sale amount is above the average sale amount of its own product category.
SELECT sale_id, product_category, salesperson, sale_amount
FROM sales s
WHERE sale_amount >
(
...
-- Q9. Find all sales where the sale amount exceeds the average sale amount of that salesperson.
